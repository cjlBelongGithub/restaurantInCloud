                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 is-hidden-sm-down">
                            <ul class="nav-top nav-top-left list-inline t-left">
                                <li><a href="terms_conditions.html"><i class="fa fa-question-circle"></i>账号指引</a>
                                </li>
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                <%--<li>
                                    <a href="#"><i class="fa fa-flag-usa"></i>中文 <i class="fa fa-caret-down"></i></a>
                                    <ul>
                               ...
                               <%-- <li>
                                ...
                                <li><a href="signin.html"><i class="fa fa-lock"></i>登入</a>
                                </li>
                                <li><a href="signup.html"><i class="fa fa-user"></i>注册</a>
                                </li>
                            </ul>
                        </div>
                    </div>
