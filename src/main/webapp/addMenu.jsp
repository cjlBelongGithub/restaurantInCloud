            ...
            <div class="page-container ptb-60">
                <div class="container">
                    <section class="sign-area panel p-40">
                        <h3 class="sign-title">添加菜谱</h3>
                        <div class="row row-rl-0">
                            <div class="col-sm-6 col-md-7 col-left">
                                <form class="p-40" action="<%=basePath%>menu/addAMenu.action" method="post" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        <label class="sr-only">菜品</label>
                                        <input type="text" name="name" class="form-control input-lg" placeholder="菜品">
                                    </div>

                                    <div class="form-group" id="file_container">
                                        <label class="sr-only">图片</label>
                                        <input type="file" name="pictures" id="attachment">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">烹饪方式</label>
                                        <input type="text" name="cookway" class="form-control input-lg" placeholder="烹饪方式">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">原料</label>
                                        <input type="text" name="materials" class="form-control input-lg" placeholder="原材料">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">价格</label>
                                        <input type="text" name="price" class="form-control input-lg" placeholder="价格">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">促销价</label>
                                        <input type="text" name="saleprice" class="form-control input-lg" placeholder="促销价">
                                    </div>
