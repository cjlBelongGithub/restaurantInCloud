        ...
        <div class="page-container ptb-60">
            <div class="container">
                <section class="sign-area panel p-40">
                    <h3 class="sign-title">登录 <small>或<a href="signup.jsp" class="color-green">注册</a></small></h3>
                    <div class="row row-rl-0">
                        <div class="col-sm-6 col-md-7 col-left">
                            <form class="p-40" action="<%=basePath%>login/check.action" method="post">
                                <div class="form-group">
                                    <label class="sr-only">登录名</label>
                                    <input type="text" class="form-control input-lg" name="name" placeholder="请输入登录名">
                                </div>
                                <div class="form-group">
